...
class Hw2Env(environment.BaseEnv):
    ...
    def step(self, action_id):
        ...
        return high_level_state, reward, terminal, truncated
...
if __name__ == "__main__":
    ...
    for episode in range(10):
        ...
        while not done:
            ...
            high_level_state, reward, is_terminal, is_truncated = env.step(action)
            done = is_terminal or is_truncated
            cumulative_reward += reward
            episode_steps += 1
        end = time.time()
        print(f"Episode={episode}, reward={cumulative_reward}, RPS={cumulative_reward/episode_steps}, steps={episode_steps}")